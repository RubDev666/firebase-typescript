...
import { getFirestore, collection, getDocs, orderBy, query, where, getDoc, doc, DocumentData } from 'firebase/firestore';

const useProducto = async (id: string): Promise<object> => {
